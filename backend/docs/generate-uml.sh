...
sed -i -E 's/entity "\*\*(attributions|attribution_values|attribution_form_fields|attributes|attribution_forms|attribute_types|attribute_data_types)\*\*"/entity "**\1**" #00ff0012 ##008800/g' "$base_dir/database.puml"
