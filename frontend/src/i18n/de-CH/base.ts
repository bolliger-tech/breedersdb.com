export const base = {
  ...
  validation: {
    ...
    invalidFields: 'Invalid form fields. Please check the form fields for errors and try again.',
    maxLen: 'The maximum length is {x}.',
    min: 'The minimum value is {x}.',
    max: 'The maximum value is {x}.',
    integer: 'Must be an integer.',
    integerBetween: 'Must be an integer between {min} and {max} with a step of {step}.',
    nameNotUnique: 'This name is already in use.',
    xMustBeGreaterThanZero: '{x} must be greater than zero.',
    noNewLinesMaxLength: 'Invalid characters or length. No new lines allowed. It must be between 1 and {max} characters long.',
    noSpecialCharsMaxLength: 'Invalid characters or length. Allowed are only numbers and letters, hyphens and underscores (no spaces or special characters). It must be between 1 and {max} characters long.',
  ...
  qr: {
    ...
    permissionHintMac: 'On MacOS: Make sure the browser is allowed camera access in "System Settings" -> "Privacy & Security" -> "Camera".',
