export const crossings = {
  ...
  nameExplainer: 'Typischerweise setzt sich der Name aus den Kürzeln der Mutter und des Vaters zusammen. Die Einhaltung dieser Konvention verhindert zudem doppeltes Erfassen von Kreuzungen.',
  hints: {
