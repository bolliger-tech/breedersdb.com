export const lots = {
  ...
  nameSegmentDataError: 'Failed to load data. Auto-generate not available, limited validation only.',
  nameOverrideHint: 'This is how the lot will be displayed. Leave it empty to use the breeding name.'
};