export const plantGroups = {
  ...
  deleteConfirmation: 'Diese Gruppe hat keine Pflanzen und wird daher dauerhaft gelöscht. Löschen?',
  disableExplainer: 'Wenn du diese Gruppe deaktivierst, kann du keine Pflanzen oder Attributierungen mehr zu dieser Gruppe hinzufügen. Wirklich deaktivieren?',
  labelIdHint: 'Automatisch generiert. Kann nicht geändert werden.',
  validation: {
    nameNotUniqueWithCultivar: 'Dieser Name wird bereits verwendet (in Kombination mit dem ausgewählten Cultivar).'
  },
  explainer: {
    examples: 'Beispiele:',
    1: {
  ...
  errors: {
    ...
    disabledNotAllowed: 'Deaktivierte Gruppen können hier nicht verwendet werden',
    labelIdNotFound: 'Die Gruppe {labelId} wurde nicht gefunden'
  },
  autocreate: {
    fetchFailed: 'Fehler beim Laden der Gruppen',
    nothingFound: 'Kein passendes Los gefunden. Erstelle zuerst das Los, falls dieses noch nicht existiert.',
